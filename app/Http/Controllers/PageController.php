	...
	public function postSignin(Request $req){
		$this->validate($req,
			...
			[
				...
				'email.email'=>'Em không đúng! Mời nhập lại!',
				'email.unique'=>'Email đã tồn tại! Hãy sử dụng email khác!',
	...
	public function postLogin(Request $req){
		...
		$credentials = array('email'=>$req->email,'password'=>$req->password);
			if(Auth::attempt($credentials)){
				...
				return redirect()->back()->with(['flag'=>'danger','message'=>'Đăng nhập không thành công! Hãy thử lại!']);
			}
